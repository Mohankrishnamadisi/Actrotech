...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="rounded-xl border border-slate-200 bg-white p-8 shadow-two transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl dark:border-white/10 dark:bg-slate-900 dark:shadow-dark"
      ...
      >
        ...
        <div className="flex items-center">
          ...
          <div className="w-full">
            ...
            <p className="text-body-color text-sm dark:text-slate-300">{designation}</p>
          </div>
        </div>
      </motion.div>
    </motion.div>
