...
export const metadata: Metadata = {
  title: "Blog | Actrotech - Software Insights and Updates",
  description: "Stay updated with the latest trends, tips, and insights from Actrotech's software development experts.",
  // other metadata
};
